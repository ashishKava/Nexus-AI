    ...
    <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-zinc-950 text-white relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-zinc-400">
          Get started with our production-grade AI platform
        </p>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-zinc-900/60 backdrop-blur-xl border border-zinc-800/80 px-8 py-10 rounded-2xl shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-sm font-semibold leading-6 text-zinc-300">
                Full Name
              </label>
              <div className="mt-2">
                <input
          ...
          <p className="mt-8 text-center text-sm text-zinc-400">
            ...
            <Link href="/login" className="font-semibold leading-6 text-indigo-400 hover:text-indigo-300 transition duration-150">
              Sign in here
            </Link>
          </p>
        </div>
